      ...
      >
        ...
        >
          <p className="text-lg text-gray-700 mb-6">
            PaperGenius revolutionizes the way educators create examination papers. Using cutting-edge AI technology, 
          ...
          <p className="text-lg text-gray-700">
            Join thousands of educators who trust PaperGenius to streamline their assessment creation process.
          </p>
        </motion.div>
      </motion.div>
    </div>
          ...
          <div className="text-center">
            ...
            <div className="space-y-4">
              <p className="text-gray-600">
                <span className="font-semibold">Email:</span> support@papergenius.com
              </p>
              <p className="text-gray-600">
